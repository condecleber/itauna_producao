        ...
        <div class="container">
            <div>
                ...
                <div class="pull-left">
                    @if(Helper::GeneralSiteSettings("contact_t5") !="")
                        <i class="fa fa-phone"></i> &nbsp;<a
                            href="tel:{{ Helper::GeneralSiteSettings("contact_t5") }}">
                            <span
                                dir="ltr">{{ Helper::GeneralSiteSettings("contact_t5") }}
                            </span>
                        </a>
                    @endif
                ...
                <div class="pull-right">    
                    ...
                    <i class="fa fa-phone"></i> &nbsp;<a
                                href="https://wa.me/{{Helper::GeneralSiteSettings('social_link10')}}">Fale Conosco</a>
                    </span>
                    @endif
